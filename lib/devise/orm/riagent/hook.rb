        ...
        module ClassMethods
          ...
          def find(*args)
            ...
            when 2 then
              ...
              raise RuntimeError, "[devise-riagent] Giving up: didn't expect #{args.length} arguments!"
            end
...
Riagent::ActiveDocument::ClassMethods.class_eval do
  include Devise::Models
  include Devise::Orm::Riagent::Hook
end